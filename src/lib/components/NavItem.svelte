...
<style>
  .menulink {
    @apply mt-1 px-2 pb-1  lg:text-2xl relative  dark:text-emphasis-high before:border-primary-light before:absolute before:content-[''] before:border-r-2 before:border-t-2  before:w-0 before:h-0 before:top-0 before:left-0 before:invisible after:border-primary-light after:absolute after:content-[''] after:border-b-2 after:border-l-2 after:w-0 after:h-0 after:bottom-0 after:right-0 after:invisible;
  }
